...
class _QRCodeViewState extends State<QRCodeView> {
  ...
  void _onQRViewCreated(QRViewController controller) {
    ...
    controller.scannedDataStream.listen((scanData) {
      setState(() {
        result = scanData;
        printLongLogMessage("scan barcode : ${result}");
        // result the result back to previous page
        if (result != null && !returnInProcess) {
          // a lock that the pop may take a while but the listener will
          // be invoke multiple times during the pop(return to previous page).
